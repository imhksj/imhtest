		...
		<div class="content">
			...
			<div class="table_wrap detail">
				...
				<table border="1">
					...
					<thead>
						<tr>
							<th scope="col" colspan="4">A/S 요청</th>
						</tr>
					</thead>
					<tbody>
						<tr>
						...
						<tr>
							...
							<th scope="row">ㆍ구입일<span class="imp">*</span></th>
							<td>
								${customerRequest.buyYear}년 ${customerRequest.buyMonth}월
							</td>
						</tr>
						<tr>
							<th scope="row">ㆍ주소<span class="imp">*</span></th>
							<td colspan="3">${customerRequest.addr}</td>
						</tr>
						<tr>
							<th scope="row">ㆍ제품명<span class="imp">*</span></th>
							<td colspan="3">${customerRequest.productName}</td>
						</tr>
						<tr>
							<th scope="row">ㆍ내용</th>
