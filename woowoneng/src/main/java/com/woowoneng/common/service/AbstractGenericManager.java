...
public abstract class AbstractGenericManager implements GenericManager {
	...
	public List<?> list(String mapper, String selectStatement, ParamUtil<String, ?> params){
	 ...
	 * @return
	 */
	public List<?> list(String mapper, String selectStatement, ParamUtil<String, ?> params, int currentPage, int pageSize) {
	...
	public List<?> list(String mapper, String selectStatement, ParamUtil<String, ?> params, RowBounds rowBounds){
		SqlSession sqlSession = null;
		try{
			sqlSession = sessFactoryIbatis.openSession();
